...
export function DownloadApp() {
  return (
    <section id="app-movil" className="mx-auto max-w-6xl px-5 py-16 sm:px-8 sm:py-20">
      <div className="flex flex-col items-center gap-6 rounded-3xl border border-border bg-card/60 p-8 text-center sm:p-12">
        <Image
          src="/icon-512.png"
          alt="Ícono de la app Cumbreva"
          width={88}
          height={88}
          className="rounded-[22px] shadow-xl shadow-primary/20"
        />
        <div>
          <div className="eyebrow text-xs text-primary">App móvil</div>
          <h2 className="heading-display mt-2 text-3xl text-foreground sm:text-4xl">
